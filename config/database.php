    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('AZURE_MYSQL_DBNAME', 'msdocs-laravel-mysql-xy-database'),
            'username' => env('AZURE_MYSQL_USERNAME', 'eicjpzlbee'),
            'password' => env('AZURE_MYSQL_PASSWORD', 'KZ4TY8G50PC035UK$'),
